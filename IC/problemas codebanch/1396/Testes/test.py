...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["224.5"]
        self.assertTrue(verificar_string("246.95", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["365.15"]
        self.assertTrue(verificar_string("387.06", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["500"]
        self.assertTrue(verificar_string("530.0", valores_entrada, self.file))
