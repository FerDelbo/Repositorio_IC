...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["152.8"]
        self.assertTrue(verificar_string("54.753410852658305", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["325.3"]
        self.assertTrue(verificar_string("79.8898366502273", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["12.7"]
        self.assertTrue(verificar_string("15.785246276190943", valores_entrada, self.file))
