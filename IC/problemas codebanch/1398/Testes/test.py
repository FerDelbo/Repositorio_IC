...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["121"]
        self.assertTrue(verificar_string("17100.0", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["450"]
        self.assertTrue(verificar_string("50500.0", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["1"]
        self.assertTrue(verificar_string("5100.0", valores_entrada, self.file))
