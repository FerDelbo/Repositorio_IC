...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("3.7768", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["0.62", "4"]
        self.assertTrue(verificar_string("1.851921333", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["0.56", "2"]
        self.assertTrue(verificar_string("1.56", valores_entrada, self.file))
