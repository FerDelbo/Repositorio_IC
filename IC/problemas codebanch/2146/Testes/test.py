...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("Teste", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["ABCdef"]
        self.assertTrue(verificar_string("abcDEF", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["proGRAmar"]
        self.assertTrue(verificar_string("PROgraMAR", valores_entrada, self.file))
