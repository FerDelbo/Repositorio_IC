...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[5,30,5,10], [20,35,15,20]"]
        resultado = verificar_string("71.25", valores_entrada, self.file, test_id=1)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_4(self):
        valores_entrada = ["[5,30,5,10], [20,35,15,20]"]
        resultado = verificar_string_tolerante("71.25", valores_entrada, self.file, test_id=4)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_2(self):
        valores_entrada = ["[5,30,5,7,52], [20,35,15,10,60]"]
        resultado = verificar_string("220.75", valores_entrada, self.file, test_id=2)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_5(self):
        valores_entrada = ["[5,30,5,7,52], [20,35,15,10,60]"]
        resultado = verificar_string_tolerante("220.75", valores_entrada, self.file, test_id=5)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_3(self):
        valores_entrada = ["[2,60,10,30,20,10], [10,70,20,35,21,10]"]
        resultado = verificar_string("299.5", valores_entrada, self.file, test_id=3)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_6(self):
        valores_entrada = ["[2,60,10,30,20,10], [10,70,20,35,21,10]"]
        resultado = verificar_string_tolerante("299.5", valores_entrada, self.file, test_id=6)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
