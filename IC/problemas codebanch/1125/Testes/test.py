...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["Lady"]
        self.assertTrue(verificar_string("Sansa", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["Fantasma"]
        self.assertTrue(verificar_string("Jon Snow", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["erro_teste"]
        self.assertTrue(verificar_string("Entrada erro_teste invalida", valores_entrada, self.file))
