...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["3, 1"]
        self.assertTrue(verificar_string("17.4", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["2, 2"]
        self.assertTrue(verificar_string("17.9", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["1, 0"]
        self.assertTrue(verificar_string("9.4", valores_entrada, self.file))
