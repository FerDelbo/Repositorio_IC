...
def verificar_string(string1, valores_entrada, arquivo, test_id):
    ...
    # GUARDA resultado mesmo com erro
...
def verificar_string_tolerante(string1, valores_entrada,arquivo, test_id):
    ...
    try:
        ...
        results.append(f"Código falhou na execução sendo {e}")
...
class TestStringVerification(unittest.TestCase):
    def test_verificar_string_1(self):
        ...
        result = verificar_string("caminhada: 164.0corrida: 207.0bicicleta: 3198.0natacao: 2820.0bicicleta", valores, self.file, 1)
        self.assertTrue(result[2])

    def test_verificar_string_2(self):
        valores = ["[6248.0,7068.0,8351.0,13344.5]"]
        result = verificar_string("caminhada: 3050.0corrida: 195.0bicicleta: 2556.0natacao: 1020.0caminhada", valores, self.file, 2)
        self.assertTrue(result[2])

    def test_verificar_string_3(self):
        valores = ["[9902.0,6825.5,15785.0,5539.0]"]
        result = verificar_string("caminhada: 195.0corrida: 325.0bicicleta: 1020.0natacao: 5698.0natacao", valores, self.file, 3)
        self.assertTrue(result[2])

    def test_verificar_string_4(self):
        valores = ["[6407.0,4872.0,10619.0,8319.5]"]
        result = verificar_string_tolerante("caminhada: 164.0corrida: 207.0bicicleta: 3198.0natacao: 2820.0bicicleta", valores, self.file, 4)
        self.assertTrue(result[2])

    def test_verificar_string_5(self):
        valores = ["[6248.0,7068.0,8351.0,13344.5]"]
        result = verificar_string_tolerante("caminhada: 3050.0corrida: 195.0bicicleta: 2556.0natacao: 1020.0caminhada", valores, self.file, 5)
        self.assertTrue(result[2])

    def test_verificar_string_6(self):
        valores = ["[9902.0,6825.5,15785.0,5539.0]"]
        result = verificar_string_tolerante("caminhada: 195.0corrida: 325.0bicicleta: 1020.0natacao: 5698.0natacao", valores, self.file, 6)
        self.assertTrue(result[2])
