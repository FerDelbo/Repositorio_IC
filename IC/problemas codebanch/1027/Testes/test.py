...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["450.35"]
        self.assertTrue(verificar_string("254.56", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["284.14"]
        self.assertTrue(verificar_string("165.23", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["289.45"]
        self.assertTrue(verificar_string("168.08", valores_entrada, self.file))
