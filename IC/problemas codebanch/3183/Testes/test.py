...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[20,19,18,17,10,9,8,7]"]
        self.assertTrue(verificar_string("[ 7  8  9 10 17 18 19 20]", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[6,6,6,5,5,5,4,4,4,3,3,3]"]
        self.assertTrue(verificar_string("[3 3 3 4 4 4 5 5 5 6 6 6]", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[4,3,2,1,0,-1,-2,-3]"]
        self.assertTrue(verificar_string("[-3 -2 -1  0  1  2  3  4]", valores_entrada, self.file))
