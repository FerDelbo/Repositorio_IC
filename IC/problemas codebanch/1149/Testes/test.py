...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["Pyke"]
        self.assertTrue(verificar_string("Greyjoy", valores_entrada, self.file))
    ...
    def test_verificar_string_3(self):
        valores_entrada = ["Campina"]
        self.assertTrue(verificar_string("Tyrell", valores_entrada, self.file))
