...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[[35,43,10,0,32],[44,133,74,16,64],[74,120,37,50,50]]"]
        self.assertTrue(verificar_string("37.85", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[[35,43,10,0,32],[44,133,74,16,64],[174,0,37,50,50]]"]
        self.assertTrue(verificar_string("33.2", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[[35,43,10,0,32],[44,133,74,16,64],[174,0,37,50,161]]"]
        self.assertTrue(verificar_string("29.44", valores_entrada, self.file))
