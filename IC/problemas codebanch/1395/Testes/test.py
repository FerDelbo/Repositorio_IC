...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["995.58"]
        self.assertTrue(verificar_string("49.78", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["4500.86"]
        self.assertTrue(verificar_string("400.09", valores_entrada, self.file))
