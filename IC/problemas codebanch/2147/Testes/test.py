...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("01004", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["12367890044"]
        self.assertTrue(verificar_string("26804", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["123"]
        self.assertTrue(verificar_string("INVALIDO", valores_entrada, self.file))
