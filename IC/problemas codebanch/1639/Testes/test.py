...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[10,20,31,1,13,15,20,33,36,63,25,10,2]"]
        self.assertTrue(verificar_string("6[ 0 1 6 8 11 12]", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[10,20,31,15,36,63,25,10,2]"]
        self.assertTrue(verificar_string("5[0 1 4 7 8]", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[10,20,31,15,36,63,26,10,2]"]
        self.assertTrue(verificar_string("6[0 1 4 6 7 8]", valores_entrada, self.file))
