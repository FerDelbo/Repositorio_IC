...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("30x^2 + 20x + 11", valores_entrada, self.file))
    ...
    def test_verificar_string_3(self):
        ...
        self.assertTrue(verificar_string("11x^4 + 50x^3 + 20x^2 + 30x + 2", valores_entrada, self.file))
