...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("NEGATIVO\nNEGATIVO\nNEGATIVO\nPOSITIVO\nPOSITIVO\nPOSITIVO", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["11", "22", "33", "0"]
        self.assertTrue(verificar_string("POSITIVO\nPOSITIVO\nPOSITIVO", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["-14", "-25", "-36", "0"]
        self.assertTrue(verificar_string("NEGATIVO\nNEGATIVO\nNEGATIVO", valores_entrada, self.file))
