...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["-1, -2, -3, 4, 5, 6, 0"]
        self.assertTrue(verificar_string("NEGATIVONEGATIVONEGATIVOPOSITIVOPOSITIVOPOSITIVO", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["11, 22, 33, 0"]
        self.assertTrue(verificar_string("POSITIVOPOSITIVOPOSITIVO", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["-14, -25, -36, 0"]
        self.assertTrue(verificar_string("NEGATIVONEGATIVONEGATIVO", valores_entrada, self.file))
