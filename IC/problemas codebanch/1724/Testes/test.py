...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[[8.7,8.6],[5.3,8.0],[0.3,4.4]]"]
        self.assertTrue(verificar_string("118.54", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[[9.5,0.5],[1.4,5.3],[9.4,2.6]]"]
        self.assertTrue(verificar_string("36.61", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[[9.4,3.0],[3.9,6.2],[8.8,5.2],[2.1,2.0]]"]
        self.assertTrue(verificar_string("102.34", valores_entrada, self.file))
