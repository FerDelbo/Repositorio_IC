...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[[8.7,8.6,2.2],[5.3,8.0,4.9],[0.3,4.4,9.9]]"]
        resultado = verificar_string("2", valores_entrada, self.file, test_id=1)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_4(self):
        valores_entrada = ["[[8.7,8.6,2.2],[5.3,8.0,4.9],[0.3,4.4,9.9]]"]
        resultado = verificar_string_tolerante("2", valores_entrada, self.file, test_id=4)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_2(self):
        valores_entrada = ["[[9.5,0.5,8.1],[1.4,5.3,4.0],[9.4,2.6,2.7]]"]
        resultado = verificar_string("1", valores_entrada, self.file, test_id=2)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_5(self):
        valores_entrada = ["[[9.5,0.5,8.1],[1.4,5.3,4.0],[9.4,2.6,2.7]]"]
        resultado = verificar_string_tolerante("1", valores_entrada, self.file, test_id=5)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_3(self):
        valores_entrada = ["[[9.4,3.0,2.6,8.5],[3.9,6.2,6.5,2.1],[8.8,5.2,8.3,9.6],[2.1,2.0,2.1,3.3]]"]
        resultado = verificar_string("2", valores_entrada, self.file, test_id=3)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_6(self):
        valores_entrada = ["[[9.4,3.0,2.6,8.5],[3.9,6.2,6.5,2.1],[8.8,5.2,8.3,9.6],[2.1,2.0,2.1,3.3]]"]
        resultado = verificar_string_tolerante("2", valores_entrada, self.file, test_id=6)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
