...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("Rochedo Casterly", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["Tully"]
        self.assertTrue(verificar_string("Correrio", valores_entrada, self.file))
