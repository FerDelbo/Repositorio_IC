...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("99.39608115313338", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["168.5"]
        self.assertTrue(verificar_string("7055.195962800127", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["324.2"]
        self.assertTrue(verificar_string("26117.72180773005", valores_entrada, self.file))
