...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[3.5,5.6,7.76,2]"]
        self.assertTrue(verificar_string("4.6", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[2.0,2.0,1.5,0]"]
        self.assertTrue(verificar_string("1.05", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[2.0,2.8]"]
        self.assertTrue(verificar_string("2.53", valores_entrada, self.file))
