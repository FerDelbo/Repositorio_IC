...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["-1.99"]
        self.assertTrue(verificar_string("3.9601", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["0.99"]
        self.assertTrue(verificar_string("0.99", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["-1.01"]
        self.assertTrue(verificar_string("1.0201", valores_entrada, self.file))
