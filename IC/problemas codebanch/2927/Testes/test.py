...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["3, 3"]
        self.assertTrue(verificar_string("7.5", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["3.5, 4"]
        self.assertTrue(verificar_string("9.5", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["3, 5"]
        self.assertTrue(verificar_string("10.5", valores_entrada, self.file))
