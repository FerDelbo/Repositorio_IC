...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["8"]
        self.assertTrue(verificar_string("54", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["32"]
        self.assertTrue(verificar_string("142.0", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["150.4, "]
        self.assertTrue(verificar_string("556.4", valores_entrada, self.file))
