...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("7.95APROVADO", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["2.22,3.33,4.44,5.55"]
        self.assertTrue(verificar_string("4.44REPROVADO", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["4.56,10.0,9.87,0.0"]
        self.assertTrue(verificar_string("5.42APROVADO", valores_entrada, self.file))
