...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["9"]
        self.assertTrue(verificar_string("512", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["13"]
        self.assertTrue(verificar_string("8192", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["19"]
        self.assertTrue(verificar_string("524288", valores_entrada, self.file))
