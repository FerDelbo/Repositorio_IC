...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["2, 5"]
        self.assertTrue(verificar_string("3.62680776", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["10, 2"]
        self.assertTrue(verificar_string("176.666666667", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["12, 35"]
        self.assertTrue(verificar_string("81377.39570643", valores_entrada, self.file))
