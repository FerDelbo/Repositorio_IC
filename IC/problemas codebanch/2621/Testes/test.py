...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("8.44", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[[35,43,10,50,32],[44,133,74,46,64],[74,12,37,50,50]]"]
        self.assertTrue(verificar_string("16.05", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[[0,20,45,100,0],[44,133,74,46,64],[74,12,37,50,50]]"]
        self.assertTrue(verificar_string("15.22", valores_entrada, self.file))
