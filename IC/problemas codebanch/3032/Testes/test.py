...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["0.57"]
        self.assertTrue(verificar_string("1", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["1.99"]
        self.assertTrue(verificar_string("1.4107", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["2.01"]
        self.assertTrue(verificar_string("1.262", valores_entrada, self.file))
