...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["90"]
        self.assertTrue(verificar_string("0.07541", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["99"]
        self.assertTrue(verificar_string("0.06833", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["121"]
        self.assertTrue(verificar_string("0.05557", valores_entrada, self.file))
