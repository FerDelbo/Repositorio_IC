...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[11.32,40.2,32,0]"]
        self.assertTrue(verificar_string("83.52", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[32,44,32.1,43.2]"]
        self.assertTrue(verificar_string("151.3", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[23,2,1]"]
        self.assertTrue(verificar_string("26", valores_entrada, self.file))
