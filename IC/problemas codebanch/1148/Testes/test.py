...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["Vale"]
        self.assertTrue(verificar_string("Stone", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["erro"]
        self.assertTrue(verificar_string("Entrada erro invalida", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["Dorne"]
        self.assertTrue(verificar_string("Sand", valores_entrada, self.file))
