...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[[27.5,31.3,30.5,28.1],[32.3,29.5,24.5,28.1],[22.4,22.7,21.5,24.1]]"]
        self.assertTrue(verificar_string("2", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[[27.5,31.3,30.5,28.1],[32.3,29.5,24.5,19.1],[22.4,22.7,21.5,24.1]]"]
        self.assertTrue(verificar_string("1", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[[27.5,31.3,23.5,21.1],[32.3,29.5,24.5,28.1],[28.4,29.7,21.5,27.1]]"]
        self.assertTrue(verificar_string("0", valores_entrada, self.file))
