...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["259.65"]
        self.assertTrue(verificar_string("149.95", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["77.7"]
        self.assertTrue(verificar_string("59.06", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["17.08"]
        self.assertTrue(verificar_string("28.78", valores_entrada, self.file))
