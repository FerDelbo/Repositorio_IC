...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["129.35"]
        self.assertTrue(verificar_string("242.07", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["10.07"]
        self.assertTrue(verificar_string("77.77", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["95.33"]
        self.assertTrue(verificar_string("195.21", valores_entrada, self.file))
