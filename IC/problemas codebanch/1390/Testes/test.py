...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["50"]
        self.assertTrue(verificar_string("60.0", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["120"]
        self.assertTrue(verificar_string("193.0", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["199, "]
        self.assertTrue(verificar_string("303.6", valores_entrada, self.file))
