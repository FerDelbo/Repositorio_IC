...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["165.7"]
        self.assertTrue(verificar_string("90.91", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["180.29"]
        self.assertTrue(verificar_string("96.26", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["221.31"]
        self.assertTrue(verificar_string("111.31", valores_entrada, self.file))
