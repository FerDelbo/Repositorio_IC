...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["92.0"]
        self.assertTrue(verificar_string("0.0109", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["-55.25"]
        self.assertTrue(verificar_string("0.0181", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["0.025"]
        self.assertTrue(verificar_string("40.0", valores_entrada, self.file))
