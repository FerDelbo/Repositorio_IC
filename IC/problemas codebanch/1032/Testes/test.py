...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("206.3", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["67.19"]
        self.assertTrue(verificar_string("133.61", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["158.18"]
        self.assertTrue(verificar_string("298.31", valores_entrada, self.file))
