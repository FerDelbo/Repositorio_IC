...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["B,L,R,R,C,B,L,P,P"]
        self.assertTrue(verificar_string("2[2 1 2 2 2]", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["B,L,L,L,C,B,L,P,P"]
        self.assertTrue(verificar_string("4[2 1 0 4 2]", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["L,C,B,L,P,P"]
        self.assertTrue(verificar_string("2[2 1 0 2 1]", valores_entrada, self.file))
