...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["TIROSINA"]
        self.assertTrue(verificar_string("181.19", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["TRIPTOFANO"]
        self.assertTrue(verificar_string("203.22", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["ASPARAGINA"]
        self.assertTrue(verificar_string("Entrada: ASPARAGINADado Invalido", valores_entrada, self.file))
