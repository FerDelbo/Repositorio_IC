...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["1232.2"]
        self.assertTrue(verificar_string("61.61", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["5055.98"]
        self.assertTrue(verificar_string("262.24", valores_entrada, self.file))
