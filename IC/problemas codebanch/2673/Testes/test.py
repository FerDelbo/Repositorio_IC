...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["13.0", "7"]
        self.assertTrue(verificar_string("11.28", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["28.29", "21"]
        self.assertTrue(verificar_string("8.43", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["20.72", "26"]
        self.assertTrue(verificar_string("5.0", valores_entrada, self.file))
