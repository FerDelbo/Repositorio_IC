...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("7[ 2  3  4  5  7  9 10]", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[10,20,31,15,36,63,25,10,2]"]
        self.assertTrue(verificar_string("4[2 3 5 6]", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[10,20,31,15,36,63,26,10,2]"]
        self.assertTrue(verificar_string("3[2 3 5]", valores_entrada, self.file))
