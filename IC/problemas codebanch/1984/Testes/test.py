...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["Campeao, 05-vezes"]
        resultado = verificar_string("BARCELONA", valores_entrada, self.file, test_id=1)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_4(self):
        valores_entrada = ["Campeao, 05-vezes"]
        resultado = verificar_string_tolerante("BARCELONA", valores_entrada, self.file, test_id=4)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_2(self):
        valores_entrada = ["Vice-Campeao, 01-vez"]
        resultado = verificar_string("CHELSEA", valores_entrada, self.file, test_id=2)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_5(self):
        valores_entrada = ["Vice-Campeao, 01-vez"]
        resultado = verificar_string_tolerante("CHELSEA", valores_entrada, self.file, test_id=5)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_3(self):
        valores_entrada = ["Campeao, 20-vezes"]
        resultado = verificar_string("TIME DE FUTEBOL NAO IDENTIFICADO", valores_entrada, self.file, test_id=3)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_6(self):
        valores_entrada = ["Campeao, 20-vezes"]
        resultado = verificar_string_tolerante("TIME DE FUTEBOL NAO IDENTIFICADO", valores_entrada, self.file, test_id=6)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
