...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[3,2,2,2,4,4,5]"]
        self.assertTrue(verificar_string("160", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[3,2,2,2,5]"]
        self.assertTrue(verificar_string("140", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[2,2,4,4,5]"]
