...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["Sand"]
        self.assertTrue(verificar_string("Dorne", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["Hill"]
        self.assertTrue(verificar_string("Terras Ocidentais", valores_entrada, self.file))
