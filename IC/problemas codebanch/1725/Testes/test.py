...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[['B','B','L','B'],['L','L','L','L'],['B','L','B','B'],['L','B','L','L']]"]
        self.assertTrue(verificar_string("7", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[['B','B','B'],['B','L','B'],['L','L','B']]"]
        self.assertTrue(verificar_string("6", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[['B','B','L','L','L'],['L','L','L','B','L'],['L','B','B','L','B'],['B','L','L','L','B'],['B','B','B','B','B']]"]
        self.assertTrue(verificar_string("13", valores_entrada, self.file))
