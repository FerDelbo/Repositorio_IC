...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("1.41", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["0.01"]
        self.assertTrue(verificar_string("0.01", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["-256.0"]
        self.assertTrue(verificar_string("16.0", valores_entrada, self.file))
