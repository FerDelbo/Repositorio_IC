...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["JOAOCARVALHO"]
        resultado = verificar_string("1.92", valores_entrada, self.file, test_id=1)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_4(self):
        valores_entrada = ["JOAOCARVALHO"]
        resultado = verificar_string_tolerante("1.92", valores_entrada, self.file, test_id=4)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_2(self):
        valores_entrada = ["JUREMA"]
        resultado = verificar_string("0.96", valores_entrada, self.file, test_id=2)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_5(self):
        valores_entrada = ["JUREMA"]
        resultado = verificar_string_tolerante("0.96", valores_entrada, self.file, test_id=5)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_3(self):
        valores_entrada = ["OJUARA"]
        resultado = verificar_string("0.94", valores_entrada, self.file, test_id=3)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_6(self):
        valores_entrada = ["OJUARA"]
        resultado = verificar_string_tolerante("0.94", valores_entrada, self.file, test_id=6)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
