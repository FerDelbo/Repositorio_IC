...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("1.92", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["JUREMA"]
        self.assertTrue(verificar_string("0.96", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["OJUARA"]
        self.assertTrue(verificar_string("0.94", valores_entrada, self.file))
