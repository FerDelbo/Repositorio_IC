...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["Arryn"]
        self.assertTrue(verificar_string("Tao alto como a honra", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["Lannister"]
        self.assertTrue(verificar_string("Oucam-me rugir", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["teste"]
        self.assertTrue(verificar_string("Entrada teste invalida", valores_entrada, self.file))
