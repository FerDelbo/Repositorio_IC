...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["4554"]
        self.assertTrue(verificar_string("22770.0", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["18215"]
        self.assertTrue(verificar_string("82860.0", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["9000"]
        self.assertTrue(verificar_string("45000.0", valores_entrada, self.file))
