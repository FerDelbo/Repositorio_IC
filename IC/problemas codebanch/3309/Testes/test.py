...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["17.23"]
        self.assertTrue(verificar_string("1246.6", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["20.8"]
        self.assertTrue(verificar_string("1496.5", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["320.64"]
        self.assertTrue(verificar_string("22485.36", valores_entrada, self.file))
