...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["2, 750, 2"]
        self.assertTrue(verificar_string("146.88", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["2, 750, 3"]
        self.assertTrue(verificar_string("147.5", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["2, 750, 4"]
        self.assertTrue(verificar_string("150.0", valores_entrada, self.file))
