...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["Arya"]
        self.assertTrue(verificar_string("Eddard Stark", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["Meera"]
        self.assertTrue(verificar_string("Howland Reed", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["teste_erro"]
        self.assertTrue(verificar_string("Entrada teste_erro invalida", valores_entrada, self.file))
