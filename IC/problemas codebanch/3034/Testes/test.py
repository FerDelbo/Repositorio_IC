...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["2.56"]
        self.assertTrue(verificar_string("1.6", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["3.99"]
        self.assertTrue(verificar_string("1.9975", valores_entrada, self.file))
