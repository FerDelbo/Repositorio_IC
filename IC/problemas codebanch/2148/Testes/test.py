...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[12,8,1,2,3,4]"]
        self.assertTrue(verificar_string("30 2", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[4,3,2,1]"]
        self.assertTrue(verificar_string("10 0", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[10,12,14,16,18,20]"]
        self.assertTrue(verificar_string("90 6", valores_entrada, self.file))
