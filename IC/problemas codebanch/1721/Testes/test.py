...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("19.76", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[[9.5,0.5],[1.4,5.3],[9.4,2.6]]"]
        self.assertTrue(verificar_string("6.1", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[[9.4,3.0],[3.9,6.2],[8.8,5.2],[2.1,2.0]]"]
        self.assertTrue(verificar_string("12.79", valores_entrada, self.file))
