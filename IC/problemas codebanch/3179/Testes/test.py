...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[2,3,4,1,1,1,-1]"]
        self.assertTrue(verificar_string("[ 2  3  4 -1  1  1  1]", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[1,1,1,5,4,3,2]"]
        self.assertTrue(verificar_string("[5 4 3 2 1 1 1]", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[1,0,1,2,0,1,4,1,5]"]
        self.assertTrue(verificar_string("[0 2 0 4 5 1 1 1 1]", valores_entrada, self.file))
