...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("121.16", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["metionina"]
        self.assertTrue(verificar_string("149.21", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["tirosina"]
        self.assertTrue(verificar_string("Entrada: tirosinaDado Invalido", valores_entrada, self.file))
