...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["Theon"]
        self.assertTrue(verificar_string("Alfie Allen", valores_entrada, self.file))
    ...
    def test_verificar_string_3(self):
        valores_entrada = ["Jon"]
        self.assertTrue(verificar_string("Kit Harington", valores_entrada, self.file))
