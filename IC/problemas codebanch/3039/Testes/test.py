...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["-0.99"]
        self.assertTrue(verificar_string("-81.89", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["1.51"]
        self.assertTrue(verificar_string("entrada invalida", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["-0.21"]
        self.assertTrue(verificar_string("102.12", valores_entrada, self.file))
