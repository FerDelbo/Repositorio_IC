...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["Sansa"]
        self.assertTrue(verificar_string("Lady", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["Bran"]
        self.assertTrue(verificar_string("Verao", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["erro_de_teste"]
        self.assertTrue(verificar_string("Entrada erro_de_teste invalida", valores_entrada, self.file))
