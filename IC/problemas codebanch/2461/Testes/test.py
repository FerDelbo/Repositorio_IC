...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["67.0"]
        self.assertTrue(verificar_string("100.5", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["234.5"]
        self.assertTrue(verificar_string("328.3", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["678.9"]
        self.assertTrue(verificar_string("882.57", valores_entrada, self.file))
