...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[1,2,6,9]"]
        self.assertTrue(verificar_string("24", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[1,2,6,12]"]
        self.assertTrue(verificar_string("33", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[1,2,5,12,20]"]
        self.assertTrue(verificar_string("57", valores_entrada, self.file))
