...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[[3,5,2],[1,4,3],[2,3,5]]"]
        self.assertTrue(verificar_string("ASSIMETRICA", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[[3,5,2],[5,4,6],[2,6,5]]"]
        self.assertTrue(verificar_string("SIMETRICA", valores_entrada, self.file))
