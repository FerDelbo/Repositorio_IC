...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["PROLINA"]
        self.assertTrue(verificar_string("116.14", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["SERINA"]
        self.assertTrue(verificar_string("105.09", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["GLUTAMINA"]
        self.assertTrue(verificar_string("Entrada: GLUTAMINADado Invalido", valores_entrada, self.file))
