...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["15"]
        self.assertTrue(verificar_string("750.0", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["45"]
        self.assertTrue(verificar_string("2750.0", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["48"]
        self.assertTrue(verificar_string("2960", valores_entrada, self.file))
