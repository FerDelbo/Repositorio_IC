...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("8.0\nAPROVOU", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[0.0,2.0,4.0,6.0]"]
        self.assertTrue(verificar_string("4.0\nREPROVOU", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[2.25,4.75,6.85,8.12]"]
        self.assertTrue(verificar_string("6.57\nAPROVOU", valores_entrada, self.file))
