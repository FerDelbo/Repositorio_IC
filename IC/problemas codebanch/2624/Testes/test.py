...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("[23.85  33.07  22.6 ]", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[[28.5,21.3,22.5,18.1],[22.3,22.5,24.5,26.1],[31.4,34.3,29.5,33.1]]"]
        self.assertTrue(verificar_string("[22.6   23.85  32.07]", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["[[27.5,21.3,23.5,28.1],[22.3,29.5,24.5,29.1],[31.4,34.3,29.5,29.1]]"]
        self.assertTrue(verificar_string("[25.1   26.35  31.07]", valores_entrada, self.file))
