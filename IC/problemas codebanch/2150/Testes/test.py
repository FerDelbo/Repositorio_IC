...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["['BOTAFOGO','FLAMENGO','FLUMINENSE','VASCO']"]
        self.assertTrue(verificar_string("[1 1 1 1]", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["['BOTAFOGO','FLAMENGO','FLUMINENSE','VASCO','BOTAFOGO','FLAMENGO','FLUMINENSE','VASCO','FLAMENGO','VASCO','FLAMENGO']"]
        self.assertTrue(verificar_string("[2 4 2 3]", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["['FLAMENGO','FLAMENGO','FLAMENGO','FLAMENGO']"]
        self.assertTrue(verificar_string("[0 4 0 0]", valores_entrada, self.file))
