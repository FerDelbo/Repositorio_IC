...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["87.4"]
        self.assertTrue(verificar_string("401.95", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["148.17"]
        self.assertTrue(verificar_string("634.85", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["238.23"]
        self.assertTrue(verificar_string("979.99", valores_entrada, self.file))
