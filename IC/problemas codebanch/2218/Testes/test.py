...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("14.0", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["[[0.32,0.48,0.56],[0.12,0.54,0.34],[0.67,0.89,0.76]]"]
        self.assertTrue(verificar_string("1.38", valores_entrada, self.file))
    ...
    def test_verificar_string_3(self):
        ...
        self.assertTrue(verificar_string("590.9", valores_entrada, self.file))
