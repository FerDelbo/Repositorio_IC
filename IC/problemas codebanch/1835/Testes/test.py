...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["20.0"]
        self.assertTrue(verificar_string("8.975979010256552", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["168.5"]
        self.assertTrue(verificar_string("26.05354252683059", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["324.2"]
        self.assertTrue(verificar_string("36.13876739612874", valores_entrada, self.file))
