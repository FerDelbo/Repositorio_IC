...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["histidina"]
        self.assertTrue(verificar_string("156.16", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["lisina"]
        self.assertTrue(verificar_string("147.2", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["metionina"]
        self.assertTrue(verificar_string("Entrada: metioninaDado Invalido", valores_entrada, self.file))
