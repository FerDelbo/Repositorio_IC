...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["Lys"]
        self.assertTrue(verificar_string("liseno", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["Qohor"]
        self.assertTrue(verificar_string("qohorik", valores_entrada, self.file))
