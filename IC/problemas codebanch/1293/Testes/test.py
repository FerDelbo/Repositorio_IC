...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["[27740,26598,15468]"]
        resultado = verificar_string("plateia: 5123.0camarotes inferiores: 1208.0camarotes superiores: 987.0plateia", valores_entrada, self.file, test_id=1)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_4(self):
        valores_entrada = ["[27740,26598,15468]"]
        resultado = verificar_string_tolerante("plateia: 5123.0camarotes inferiores: 1208.0camarotes superiores: 987.0plateia", valores_entrada, self.file, test_id=4)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_2(self):
        valores_entrada = ["[47612,78142,60342]"]
        resultado = verificar_string("plateia: 1322.0camarotes inferiores: 7054.0camarotes superiores: 3265.0camarotes inferiores", valores_entrada, self.file, test_id=2)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_5(self):
        valores_entrada = ["[47612,78142,60342]"]
        resultado = verificar_string_tolerante("plateia: 1322.0camarotes inferiores: 7054.0camarotes superiores: 3265.0camarotes inferiores", valores_entrada, self.file, test_id=5)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_3(self):
        valores_entrada = ["[2164,9042,10890]"]
        resultado = verificar_string("plateia: 16.0camarotes inferiores: 350.0camarotes superiores: 820.0camarotes superiores", valores_entrada, self.file, test_id=3)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
    
    def test_verificar_string_6(self):
        valores_entrada = ["[2164,9042,10890]"]
        resultado = verificar_string_tolerante("plateia: 16.0camarotes inferiores: 350.0camarotes superiores: 820.0camarotes superiores", valores_entrada, self.file, test_id=6)
        self.assertTrue(resultado[2], msg=f"String1 = {resultado[1]} resultado obtido = {resultado[0]}")
