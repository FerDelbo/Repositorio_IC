...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        valores_entrada = ["142"]
        self.assertTrue(verificar_string("90.2", valores_entrada, self.file))
    
    def test_verificar_string_2(self):
        valores_entrada = ["250"]
        self.assertTrue(verificar_string("203.5", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["501, "]
        self.assertTrue(verificar_string("391.75", valores_entrada, self.file))
