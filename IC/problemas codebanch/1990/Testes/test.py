...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_2(self):
        valores_entrada = ["TREONINA"]
        self.assertTrue(verificar_string("119.12", valores_entrada, self.file))
    
    def test_verificar_string_3(self):
        valores_entrada = ["GLICINA"]
        self.assertTrue(verificar_string("Entrada: GLICINADado Invalido", valores_entrada, self.file))
